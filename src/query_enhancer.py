...
class QueryEnhancer:
    ...
    def _determine_intent(self, question: str) -> str:
        ...
        if any(
            ...
            for word in ["trend", "pattern", "increase", "decrease"]
        ):
            return "monitor_performance"
        elif any(
            word in question_lower for word in ["compare", "vs", "versus", "difference"]
        ):
            return "competitive_analysis"
        elif any(word in question_lower for word in ["why", "reason", "cause", "root"]):
            return "root_cause_analysis"
        elif any(
            word in question_lower for word in ["improve", "better", "fix", "solve"]
        ):
